...
<div align="center">
  <img src="../images/10-figures/10-1.png" alt="MCP设计思想" width="85%"/>
  <p>图 10.1 MCP 设计思想</p>
</div>
...
<div align="center">
  <img src="../images/10-figures/10-2.png" alt="A2A设计思想" width="85%"/>
  <p>图 10.2 A2A 设计思想</p>
</div>
...
<div align="center">
  <img src="../images/10-figures/10-3.png" alt="ANP设计思想" width="85%"/>
  <p>图 10.3 ANP 设计思想</p>
</div>
...
<div align="center">
  <p>表 10.1 三种协议对比</p>
  <img src="../images/10-figures/10-table-1.png" alt="三种协议对比" width="85%"/>
</div>
...
<div align="center">
  <img src="../images/10-figures/10-4.png" alt="HelloAgents通信协议架构" width="85%"/>
...
<div align="center">
  <img src="../images/10-figures/10-5.png" alt="MCP案例演示" width="85%"/>
  <p>图 10.5 MCP 案例演示</p>
</div>
...
<div align="center">
  <p>表 10.2 MCP 核心能力</p>
  <img src="../images/10-figures/10-table-2.png" alt="MCP核心能力" width="85%"/>
</div>
...
<div align="center">
  <img src="../images/10-figures/10-6.png" alt="MCP工作流程" width="85%"/>
  <p>图 10.6 MCP 案例演示</p>
</div>
...
<div align="center">
  ...
  <img src="../images/10-figures/10-table-3.png" alt="Function Calling与MCP对比" width="85%"/>
</div>
...
<div align="center">
  ...
  <img src="../images/10-figures/10-table-4.png" alt="MCP传输方式对比" width="85%"/>
</div>
...
<div align="center">
  ...
  <img src="../images/10-figures/10-table-5.png" alt="常用官方MCP服务器" width="85%"/>
</div>

<div align="center">
  <p>表 10.6 社区热门 MCP 服务器</p>
  <img src="../images/10-figures/10-table-6.png" alt="社区热门MCP服务器" width="85%"/>
</div>
...
<div align="center">
  <p>表 10.7 A2A 核心概念</p>
  <img src="../images/10-figures/10-table-7.png" alt="A2A核心概念" width="85%"/>
</div>

为实现对协作过程的管理，A2A 为任务定义了标准化的生命周期，包括创建、协商、代理、执行中、完成、失败等状态，可见图 10.7。

<div align="center">
  <img src="../images/10-figures/10-7.png" alt="A2A任务生命周期" width="85%"/>
  <p>图 10.7 A2A 任务周期</p>
</div>
...
<div align="center">
  <img src="../images/10-figures/10-8.png" alt="A2A请求生命周期" width="85%"/>
...
<div align="center">
  <p>表 10.8 ANP 核心概念</p>
  <img src="../images/10-figures/10-table-8.png" alt="ANP核心概念" width="85%"/>
</div>
...
<div align="center">
  <img src="../images/10-figures/10-9.png" alt="ANP整体流程" width="85%"/>
  <p>图 10.9 ANP 整体流程</p>
</div>
...
<div align="center">
  <img src="../images/10-figures/10-10.png" alt="Smithery发布成功页面" width="85%"/>
...
<div align="center">
  <img src="../images/10-figures/10-11.png" alt="Smithery发布成功的MCP工具" width="85%"/>
